...
- We know a point falls within the circle if x^2 + y^2 is less than or equal to the radius. By repeatedly sampling from numbers within the range of the rectangle that encompasses the circle, we can approximate the area of the circle and the area of the rectangle, and then solve for Pi.  
```{r}
runs = 100000L
radius = 0.5
