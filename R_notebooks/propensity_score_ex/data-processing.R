...
p_load(here, haven, sjmisc, tidyverse)



## Data: https://www.childandfamilydataarchive.org/cfda/archives/cfda/studies/4075
dta = here("R_notebooks/propensity_score_matching_ex", "04075-0001-Data.por") %>%
  read_por()


## Cleaning: https://github.com/sejdemyr/ecls/blob/master/R/ecls-clean.R
...
write.csv(dta, 
          here("R_notebooks/propensity_score_matching_ex/ecls-processed.csv"))
